...
const SearchResults = () => {
    ...
    const [filters, setFilters] = useState({ priceRange: [0, 0], airline: [], stops: null, selectedTimeSlot: "", sortBy: "Lowest" });
        ...
        const handleFilter = () => {
            ...
            if (filters.sortBy) {
                updatedFlights.sort((a, b) => {
                    const priceA = convertPrice(a?.fare?.adults, currency);
                    const priceB = convertPrice(b?.fare?.adults, currency);
                        ...
                        <div className="filtercontainer">
                            ...
                            <div className="sidefilterbar">
                                ...
                                <div className="text-center">
                                    <h3 className="text-center"> {flights.length}-Results Found </h3>
                                </div>
                                        ...
                                        {Object.entries(airlineCounts).map(([airline, { count, minPrice }]) => (
                                            <div key={airline}>
                                                <label className="d-flex">
                                                    ...
                                                    />
                                                    <p className="fs-7"> {airline} <span> ({count} ) </span> <span> {minPrice} </span>  </p>
                                                </label>
                                            </div>
                                        ))}
