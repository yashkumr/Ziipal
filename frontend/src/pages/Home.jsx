          ...
          <div id="carouselExample" className="carousel slide" >
            <div className="carousel-inner " style={{height:"70vh"}}>
              ...
              <div className="carousel-item">
                <img src={banner4} className="d-block w-100" alt="banner2" />
              </div>
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="theme_search_form_area mt-3 pt-3">
                  <div className="theme_search_form_tabbtn theme-search-form-area-tabRow">
                                ...
                                <form action="#!">
                                  <div className="row">
                                    ...
                                    <div className="top_form_search_button p-0 col-lg-1" style={{ height: 70 }}>
                                      <a href="one_way.html" className="btn btn_theme btn_md tab-search-btn">Search
                                          ...
                                          <div class="row">
                                              <div class="col-lg-3 col-md-12 col-sm-12 col-12">
                                                  <div class="flight_Search_boxed">
                                                      <p>Destination</p>
                                                      <input type="text" value="" placeholder="Domestic">
                                                      <span>Where are you going?</span>
                                                  </div>
                                              </div>
                                              <div class="col-lg-3 col-md-12 col-sm-12 col-12">
                                                  <div class="flight_Search_boxed">
                                                      <p>Duration</p>
                                                      <input type="text" value="" placeholder="Enter Duration">
                                                  ...
                                                  <div class="form_search_date">
                                                      <div class="flight_Search_boxed date_flex_area">
                                                          <div class="Journey_date">
                                                              <p>DATE OF DEPART</p>
                                                              <input type="date" value="2024-05-03">
                                                              <span>Thursday</span>
                                                          </div>
                                                          <div class="Journey_date">
                                                              <p>DATE OF RETURN</p>
                                                              <input type="date" value="2024-05-07">
                                                              <span>Saturday</span>
                                                          </div>
                                                      </div>
                                                  </div>
                                              ...
                                              <div class="col-lg-2 col-md-12 col-sm-12 col-12">
                                                  <div class="flight_Search_boxed">
                                                      <p>No. of Pax</p>
                                                      <input type="tel" value="" placeholder="Enter Duration">
                                                      <span>Enter no. of Pax?</span>
                                                  </div>
                                              </div>
                                              <div class="top_form_search_button mt-3">
                                                  <a href="insurance-list.php"
                                                      class="btn btn_theme btn_md">Search</a>
                                              </div>
                                          </div>
                                      </form>
                                  </div>
